...
class HotKeywords(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.url = "http://{0}/{1}".format(config.URL.JJB_URL, cdp_route_params.CompanyHotKeywords.route)
        self.params = cdp_route_params.CompanyHotKeywords.params

    def tearDown(self):
        print("company_hot_keywords: ", self.result)

    def test_company_hot_keywords(self):
        """搜索工厂搜索词"""
