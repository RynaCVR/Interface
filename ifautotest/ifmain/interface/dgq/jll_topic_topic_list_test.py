...
class TopicList(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.url = "http://{0}/{1}".format(config.URL.DGQ_URL, dgq_route_params.JllTopicTopicList.route)
        self.params = dgq_route_params.JllTopicTopicList.params

    def tearDown(self):
        print("TopicList: ", self.result)
